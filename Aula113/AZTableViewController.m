...
//  Aula113
//
//  Created by André Festrati on 07/10/14.
//  Copyright (c) 2014 André Festrati. All rights reserved.
//
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        cell.textLabel.text = [NSString stringWithFormat:@"I am in section 0"/*, indexPath.row*/];
